...
function HeroSection() {
  return (
    ...
    >
      ...
      {/* Contenu principal */}
      <div className="relative z-10 max-w-7xl mx-auto text-center mt-20 text-white px-4 sm:px-6 lg:px-8 space-y-16">
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold">
          La conciergerie <span className="text-red-500">qui vous libère !</span>
        </h1>
        <p className="text-lg sm:text-xl md:text-1xl max-w-3xl mx-auto">
